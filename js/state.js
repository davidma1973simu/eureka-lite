...
const AppState = {
  ...
  getGreeting() {
    ...
    if (hour < 12) return I18N.t('greeting.morning', '早上好');
    if (hour < 18) return I18N.t('greeting.afternoon', '下午好');
    return I18N.t('greeting.evening', '晚上好');
  },

  // Get user name
  getUserName() {
    return this.user?.name || I18N.t('user.friend', '朋友');
  }
};
